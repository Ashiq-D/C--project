...
function Scene() {
    ...
    return (
        <group>
            {/* Primary arcs — red/gold warm gradient */}
            <FlowingArc points={leftArc} color="#ff4b3e" speed={0.8} opacity={0.6} width={0.25} />
            <FlowingArc points={leftArc} color="#d4a93a" speed={0.5} opacity={0.35} width={0.6} />

            <FlowingArc points={rightArc} color="#d4a93a" speed={0.7} opacity={0.55} width={0.25} />
            <FlowingArc points={rightArc} color="#f2c14e" speed={0.4} opacity={0.3} width={0.7} />

            {/* Inner accent — warm red */}
            <FlowingArc points={innerArc} color="#ff6b5a" speed={1.2} opacity={0.4} width={0.18} />

            {/* Bottom sweep — deep amber */}
            <FlowingArc points={bottomArc} color="#b8860b" speed={0.6} opacity={0.28} width={0.4} />
        </group>
    );
}
