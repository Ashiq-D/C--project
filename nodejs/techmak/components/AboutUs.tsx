...
export default function AboutUs() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden pt-8 pb-32 md:pt-16 z-10"
    >
      {/* ── Ambient background ── */}
      <FloatingParticles />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="mb-32">
          <motion.div
            ...
            className="text-center mb-14 max-w-3xl mx-auto backdrop-blur-md bg-[#052626]/40 rounded-3xl md:rounded-full p-6 md:p-8 border border-white/5 shadow-2xl"
          >
            <h3
